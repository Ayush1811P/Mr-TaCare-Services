...
export function PetToysCard({ product }: { product: PetToysProduct }) {
  return (
    <div className="flex flex-col overflow-hidden rounded-2xl border border-gray-100 bg-white shadow-sm transition-all hover:shadow-xl">
      <div className="relative aspect-square w-full bg-white p-4">
        <Image
          src={product.imageUrl || '/images/pet-toys.jpg'}
          alt={product.name}
          fill
      ...
      <div className="flex flex-1 flex-col p-5">
        ...
        <div className="mt-2 flex items-center justify-between">
          <div className="flex items-center space-x-1">
            ...
            <span className="text-sm font-semibold text-gray-700">{product.rating || 'N/A'}</span>
            {product.reviewCount && (
