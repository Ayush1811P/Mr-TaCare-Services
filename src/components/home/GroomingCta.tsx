...
export function GroomingCta() {
  return (
    <section aria-labelledby="grooming-cta-heading" className="bg-cream-50 pb-20 sm:pb-24">
      <div className="container-page">
        <div className="relative overflow-hidden rounded-[1.75rem] bg-teal-800 px-7 py-14 text-center sm:px-12 sm:py-16">
          ...
          <div className="relative">
            <h2
              id="grooming-cta-heading"
              className="text-cream-50 mx-auto max-w-2xl text-3xl font-extrabold sm:text-4xl"
            >
              Your pet needs grooming. Let&apos;s book it.
            </h2>
            <p className="mx-auto mt-4 max-w-xl text-lg leading-relaxed text-teal-100">
              Professional pet grooming across {defaultServiceArea.city}, reachable on WhatsApp in
              about two minutes.
            </p>
            <ButtonLink href="/how-it-works" size="lg" variant="inverse" className="group mt-8">
              Coming Soon
