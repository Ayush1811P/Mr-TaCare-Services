import type { PetFoodProduct, PetFoodAnimalType, PetFoodLifeStage } from '@/types/pet-food';
...
export function normalizeSerpApiProduct(
  ...
  // Attempt to extract price. SerpApi Google Shopping usually provides 'extracted_price' or 'price'.
  let price = null;
  ...
  return {
    ...
    name: raw.title,
    imageUrl: raw.thumbnail || '/images/pet-food.jpg', // Fallback image
    price,
    currency: 'INR', // Forced to INR since we're using gl=in
